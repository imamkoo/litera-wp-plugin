...
export const QuizModal: React.FC<QuizModalProps> = ({ 
  ...
  const handleNext = async () => {
    ...
    const newAnswers = [...answers, { questionId: currentQuestion.id, optionId: selectedOptionId }];
          ...
          <>
            {step === 'intro' && (
              <>
                <ModalHeader className="flex flex-col gap-1 items-center pt-8">
                  ...
                  <h2 className="text-2xl font-black text-slate-800">Knowledge Check Required</h2>
                </ModalHeader>
                <ModalBody className="py-6 text-center">
                  ...
                  <div className="flex justify-center gap-6 text-sm font-bold text-slate-600 bg-slate-50 p-4 rounded-2xl">
                    ...
                    <div className="flex flex-col items-center">
                      <span className="text-2xl text-blue-600">{passingScore}%</span>
            ...
            {step === 'submitting' && (
              <ModalBody className="py-16 text-center flex flex-col items-center justify-center">
                ...
                <h3 className="text-xl font-bold text-slate-800">Menilai Jawaban Anda...</h3>
                <p className="text-slate-500 font-medium">Harap tunggu sebentar, kami sedang memverifikasi hasil kuis.</p>
              </ModalBody>
            )}
            ...
            {step === 'result' && quizResult && (
              <>
                ...
                <ModalBody className="py-6 text-center">
                  <p className="text-slate-500 font-medium mb-2">Your Score</p>
